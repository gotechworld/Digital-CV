...
with tabs[4]:
    ...
    with col1:
        ...
        st.markdown('<div class="skill-box">', unsafe_allow_html=True)
        st.markdown("### Master's Degree in Criminal Law")
        st.markdown("**University of Spiru-Haret, Bucharest** | 2008 - 2010")
        st.markdown("Specialized in Patents, Trademarks, and Copyright Law.")
        st.markdown("**Thesis:** *Secure Innovation: How to Protect Your Patents and Trademarks.*")
        st.markdown('</div>', unsafe_allow_html=True)
        
        st.markdown('<div class="skill-box">', unsafe_allow_html=True)
        st.markdown("### Bachelor's Degree in Law")
        st.markdown("**University of Spiru-Haret, Bucharest** | 2004 - 2008")
        st.markdown("Focus on Intellectual Property")
        st.markdown("**GPA:** 9.8/10.0")
        st.markdown('</div>', unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True)
        # Skills timeline with detailed progression
        st.markdown("### 📈 Professional Skills Evolution")
        st.markdown("""
        This timeline shows my professional journey and skill development over the years.
        Each bar represents continuous growth and expertise development in key technical domains.
        """)
        
        # Create a more detailed dataframe for the timeline with skill proficiency milestones
        skills_timeline_data = [
            # Skill, Start Year, End Year, Proficiency Level, Milestone Description
            {"Skill": "Python", "Start": 2015, "End": 2017, "Level": "Intermediate", "Description": "Backend Development"},
            {"Skill": "Python", "Start": 2017, "End": 2020, "Level": "Advanced", "Description": "Data Analysis & Automation"},
            {"Skill": "Python", "Start": 2020, "End": 2025, "Level": "Expert", "Description": "AI/ML Development"},
            
            {"Skill": "DevOps", "Start": 2017, "End": 2019, "Level": "Intermediate", "Description": "CI/CD Implementation"},
            {"Skill": "DevOps", "Start": 2019, "End": 2021, "Level": "Advanced", "Description": "Infrastructure as Code"},
            {"Skill": "DevOps", "Start": 2021, "End": 2025, "Level": "Expert", "Description": "DevSecOps Integration"},
            
            {"Skill": "Cloud", "Start": 2018, "End": 2020, "Level": "Intermediate", "Description": "AWS & Azure Basics"},
            {"Skill": "Cloud", "Start": 2020, "End": 2022, "Level": "Advanced", "Description": "Multi-cloud Architecture"},
            {"Skill": "Cloud", "Start": 2022, "End": 2025, "Level": "Expert", "Description": "Cloud Security & Optimization"},
            
            {"Skill": "AI/ML", "Start": 2020, "End": 2021, "Level": "Intermediate", "Description": "ML Fundamentals"},
            {"Skill": "AI/ML", "Start": 2021, "End": 2023, "Level": "Advanced", "Description": "NLP & LLMs"},
            {"Skill": "AI/ML", "Start": 2023, "End": 2025, "Level": "Expert", "Description": "Generative AI Engineering"},
            
            {"Skill": "Security", "Start": 2019, "End": 2020, "Level": "Intermediate", "Description": "Application Security"},
            {"Skill": "Security", "Start": 2020, "End": 2022, "Level": "Advanced", "Description": "Security Automation"},
            {"Skill": "Security", "Start": 2022, "End": 2025, "Level": "Expert", "Description": "AI/ML Security"}
        ]
        
        df_timeline = pd.DataFrame(skills_timeline_data)
        
        # Create a custom color map for proficiency levels
        color_map = {
            "Intermediate": "#74c476",  # Light green
            "Advanced": "#31a354",      # Medium green
            "Expert": "#006d2c"         # Dark green
        }
        
        # Map the levels to colors
        ...
        fig.update_layout(
            title={
                "text": "Professional Skills Development Journey",
                "y": 0.95,
                "x": 0.5,
                "xanchor": "center",
                "yanchor": "top",
            ...
            xaxis_title="Year",
            yaxis_title="Technical Domain",
            height=400,
            paper_bgcolor="rgba(0,0,0,0)",
            plot_bgcolor="rgba(0,0,0,0)",
            font=dict(color="white"),
            legend_title="Proficiency Level",
            hovermode="closest",
            xaxis=dict(
                showgrid=True,
            ...
            yaxis=dict(
                showgrid=False,
                tickfont=dict(size=14, color="#4c8bf5")
            ),
        ...
        fig.add_shape(
            ...
            y0=-0.5,
            x1=current_year,
            y1=len(df_timeline["Skill"].unique()) - 0.5,
